  ...
  return (
    <nav className="bg-white border-b border-gray-200 px-4 py-3 shadow-sm">
      <div className="flex items-center justify-between w-full px-6 mx-auto">
        {/* Logo Section */}
        <div className="flex items-center space-x-4">
          <img src="/soilLogo.png" alt="Logo" className="h-20 w-auto" />
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            <button 
              className="flex items-center border border-gray-600 justify-center w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors"
            ...
            {/* User Info Tooltip */}
            {showUserTooltip && session?.user && (
              <div 
                ref={tooltipRef}
                className="absolute right-0 top-full mt-2 w-64 bg-gray-800 text-white rounded-lg shadow-lg z-50 p-3"
                onMouseEnter={() => setShowUserTooltip(true)}
                onMouseLeave={() => setShowUserTooltip(false)}
              >
                {/* Tooltip Arrow */}
